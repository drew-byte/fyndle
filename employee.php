            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Employee Information</h3>
                                ...
                                <tbody class="table-group-divider">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit.php?id=<?php echo $row['id'] ?>" class=""><i class="fa-solid fa-pen-to-square fs-5 me-3" style="color: #9a9996;"></i></a>
                                                <a href="delete.php?id=<?php echo $row['id'] ?>" class=""><i class="fa-solid fa-trash fs-5 me-3" style="color: #9a9996;"></i></a>
                                            </td>
