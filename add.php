        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "INSERT INTO `accounts`(id, firstName, lastName, number , gender ,email, password, address, city, country) VALUES (NULL,'$firstName','$lastName','$number','$gender','$email','$password','$address','$city','$country')";
