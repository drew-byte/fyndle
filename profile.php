            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                ...
                <div class=container-fluid>
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">User Profile</h3>
                ...
                <div class="container">
                    ...
                    <div class="card pl-5 pr-5">
                        <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="assets/img/user.png" width="300" height="300">
                                        ...
                                        <tr>
                                            <th>
                                                <div class="row text-dark mt-3">
                                                    ...
                                                    <h3 class="col col-lg-6" name>Name : <?php echo $data['firstName'] . ", " . $data['lastName']; ?></h3>
                                                    <h3 class="col col-lg-6">Mobile Number : <?php echo $data['number'] ?></h3>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th>
                                                <div class="row text-dark mt-3">
                                                    <h3 class="col col-lg-6">Gender : <?php echo $data['gender']; ?></h3>
                                                    <h3 class="col col-lg-6">Address : <?php echo $data['address']; ?></h3>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th>
                                                <div class="row text-dark mt-3">
                                                    <h3 class="col col-lg-6">City : <?php echo $data['city']; ?></h3>
                                                    <h3 class="col col-lg-6">Country : <?php echo $data['country']; ?></h3>
                                                </div>
                                            </th>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="mb-3"><button class="btn btn-primary "><a href="settings.php" style="height: 30px;
                                font-size: 15px;
                                text-decoration: none; color:white; ">Edit</a></button></div>
