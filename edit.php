        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "UPDATE `accounts` SET `firstName`='$firstName',`lastName`='$lastName',`number`='$number',`gender`='$gender',`address`='$address',`city`='$city',`country`='$country' WHERE id = $id";
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow border-start-success py-2">
                        <div class="text-center mb-4 ">
                            <br>
                            <br>
                            <h3 class="text-dark mb-4">Edit User Information</h3>
                        ...
                        <div>
                            <div class="p-5 ">
                                ...
                                <form method="post">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="text" placeholder="Number" name="number"></div>
                                    ...
                                    <div class="text-dark fw-bold h5 mt-5 mb-0" style="height: 24px;">
                                        <button class="btn btn-success badge" type="submit" name="submit">
