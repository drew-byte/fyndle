            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Project</h3>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="card shadow border-start-success py-2 mt-5 col col-lg-12">
                                <h1 style="color:black;margin-left:20px; margin-top:20px"><i>Host</i></h1>
                                ...
                                <table class="table">
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM `project` WHERE  creator = '{$data['email']}'";
                                        ;
                        ...
                        <div class="row">
                            <div class="card shadow border-start-success py-2 mt-5 col col-lg-12">
                            <h1 style="color:black;margin-left:20px; margin-top:20px"><i>Joined</i></h1>
                            <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">Creator</th>
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM `joinedProject` WHERE  joined = '{$data['email']}'";
