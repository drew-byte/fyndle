            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                ...
                <div class="container-fluid">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $allowed = array('jpg', 'jpeg', 'png', 'pdf', 'docs', 'docx', 'ico', 'txt','ktr');
                        ...
                        if (in_array($fileActualExt, $allowed)) {
                            if ($fileError === 0) {
                                if ($fileSize < 500000) {
                                    ...
                                    $sql = "INSERT INTO `files`(id,fileName,fileSize,fileType) VALUES (NULL,'$fileName','$fileSize','$fileType')";
                                    $result = mysqli_query($conn, $sql);

                                    move_uploaded_file($fileTempName, $fileDestination);


                                    header("Location: documents.php?uploadsuccess");
                                } else {
                    ...
                    <div class="container">
                        <form method="post" class="justify-content-center" enctype="multipart/form-data">
                            <div class="form-group">
                                <input type="file" name="file" placeholder="Upload File" class="form-control" >
                            ...
                            <tbody class="table-group-divider">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="downloads.php?id=<?php echo $row['id'] ?>" class=""><i class="fa-solid fs-5 fa-download me-3" style="color: #9a9996;"></i></a>
                                            <a href="delete3.php?id=<?php echo $row['id'] ?>" class=""><i class="fa-solid fa-trash fs-5 me-3" style="color: #9a9996;"></i></a>
                                        </td>
